...
//   type CompoundKeyCompareFirst<'T when 'T : comparison> = 
//      { Key1: 'T; Key2: 'T } 
//         interface IEquatable<CompoundKeyCompareFirst<'T>> with
//            member this.Equals other = other.Key1.Equals this.Key1
//         interface IComparable<CompoundKeyCompareFirst<'T>> with 
//            member this.CompareTo other = 
//               let o = other.Key1
//               let t = this.Key1
//               if t < o then -1 else if t > o then 1 else 0
/////////////////
/////////////////   let secondaryIndexNode 
/////////////////                  (rocksDbName: string)
/////////////////                  (userSuppliedKeyValueMappingFunction: 'Key -> 'Value -> Option<'NewKey * 'NewValue>) 
/////////////////                  (source: IObservable<Delta<'Key, 'Value> seq>)
/////////////////                  : PartiallySubscribableSubject<CompoundKey<'NewKey, 'Key>, 'NewValue, Delta<CompoundKey<'NewKey, 'Key>, 'NewValue> seq> = 
/////////////////      let index = (new RocksIndex<CompoundKey<'NewKey, 'Key>, 'NewValue>(db, rocksDbName) :> IIndex<CompoundKey<'NewKey, 'Key>, 'NewValue>) 
/////////////////      let observers = new List<CompoundKey<'NewKey, 'Key> * CompoundKey<'NewKey, 'Key> * Subject<Upsert<CompoundKey<'NewKey, 'Key>, 'NewValue> seq>>()
/////////////////      let compareFunction = (fun x y -> if x.Key1 < y.Key1 then -1 else if x.Key1 > y.Key1 then 1 else 0)
/////////////////      let observable = PartiallySubscribableSubject<CompoundKey<'NewKey, 'Key>, 'NewValue, Delta<CompoundKey<'NewKey, 'Key>, 'NewValue> seq>( fun key1 key2 userSuppliedSubscriptionHandler ->
/////////////////         let observer = new Subject<Upsert<CompoundKey<'NewKey, 'Key>, 'NewValue> seq>()
...
/////////////////                              delta.Key 
/////////////////                              delta.NextValue 
/////////////////                              (HelperFunctions.bindKeyOptionValueToOptionKeyValue userSuppliedKeyValueMappingFunction) 
/////////////////                              HelperFunctions.leftKeyExpansion
...
/////////////////         // TODO remember to dedup this by combining any oldkey -> newkey followed by newkey -> newnewkey to just oldkey -> newnewkey
/////////////////         // question is this important or is this just an optimization
/////////////////         observers |> HelperFunctions.updateSubscriptions emits compareFunction
/////////////////         // TODO here too
